<template>
  <div>
    <div class="app-user-search-filter d-flex align-center flex-wrap gap-4 mb-2">
      ...
      <LigneDialogForm @userData="addNewClient" />
    </div>
...
import LigneDialogForm from "@/views/Reutilisable/LigneDialogForm.vue";
const rowData = ref([]);
...
const fetchData = () => {
  return fetch("http://51.178.42.116:8089/api/clients")
    ...
    ({
      ...client,
      dateCreation: formatTimestamp(client.dateCreation),
    })
